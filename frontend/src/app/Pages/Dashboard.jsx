...
import { Dataset, Contribution, Verification, User } from "@/entities/all";
...
export default function Dashboard() {
  ...
  const loadDashboardData = async () => {
    try {
      ...
      const verifications = await Verification.list();
      ...
      const userContributions = contributions
        .filter(c => c.contributor === currentUser.email)
        .slice(0, 3);
      const userVerifications = verifications
        .filter(v => v.verifier === currentUser.email)
        .slice(0, 3);
